        ...
        <div class="layout-top-spacing" v-if="usuario">
            <div class="row">
                <div class="chat-system" style="height: 100%;">
                                                    ...
                                                    <div class="meta-info">
                                                        ...
                                                        <div class="f-head">
                                                            <i class="bi bi-whatsapp"
                                                                v-if="person.chat_info && person.chat_info.type == 'WhatsApp'"></i>
                                                            <i class="bi bi-globe"
                                                                v-if="person.chat_info && person.chat_info.type == 'web'"></i>
                                                        </div>
                                                    </div>
                    ...
                    <chatAtendimento :chatProps="selected_user" :allMessages="messages" :user="usuario.nome"
                        v-if="selected_user">
                    </chatAtendimento>
