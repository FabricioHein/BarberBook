    ...
    <div class="layout-px-spacing todo-list">
        ...
        <div class="row layout-top-spacing">
            <div class="col-xl-12 col-lg-12 col-md-12">
                ...
                <div id="addTarefa" class="modal fade" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
const initPopup = () => {
    addTarefa = new window.bootstrap.Modal(document.getElementById('addTarefa'));
};
