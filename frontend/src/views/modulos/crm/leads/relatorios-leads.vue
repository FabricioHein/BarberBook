<template src="./relatorios-leads.html"></template>
<style scoped src="./relatorios-leads.css"></style>
...
export default {
    ...
    methods: {
        getAcesso() {
            this.acesso = Acesso.getAcesso('CRM', '/relatorios-leads', this.permissao);
