        ...
        <div class="row layout-top-spacing">
                ...
                <div class="widget widget-statistics">
                    ...
                    <div class="widget-content">
                        <div class="row">
                            <div class="col-6">
                                <div class="w-detail">
                                    <p class="w-title">Total Contatos</p>
                                    <p class="w-stats"> {{ dashData.totalCliente }}</p>
                            ...
                            <div class="col-6">
                                <div class="w-detail">
                                    <p class="w-title">Leads Ativos</p>
                                    <p class="w-stats">{{ dashData.totalLeads }}</p>
                                </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                <div class="widget widget-expenses">
                    ...
                    <div class="widget-content">
                        <p class="value">
                            R$ {{ dashData.totalPotencialNegocioInicial }}
