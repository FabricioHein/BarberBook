                    ...
                    <div class="col-lg-12 layout-spacing">
                        <div class="statbox panel box box-shadow">
                            ...
                            <div class="panel-body">
                                <form-wizard shape="tab" title="" subtitle="" class="pills text-only" color="#4A5FC1000">
...
&lt;/form-wizard&gt;
                    ...
                    <div class="col-lg-12 layout-spacing">
                        <div class="statbox panel box box-shadow">
                            ...
                            <div class="panel-body">
                                <form-wizard shape="tab" title="" subtitle="" class="pills" color="#4A5FC1000">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 layout-spacing">
                        <div class="statbox panel box box-shadow">
                            ...
                            <div class="panel-body">
                                <form-wizard title="" subtitle="" class="circle" color="#4A5FC1000">
                                    <tab-content title="" icon="far fa-list-alt">
                                        <p>Try the keyboard navigation by clicking arrow left or right!</p>
                                    </tab-content>
                                    <tab-content title="" icon="far fa-user">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 layout-spacing">
                        <div class="statbox panel box box-shadow">
                            ...
                            <div class="panel-body">
                                <form-wizard shape="square" title="" subtitle="" class="square" color="#4A5FC1000">
                                    <tab-content title="" icon="far fa-list-alt">
                                        <p>Try the keyboard navigation by clicking arrow left or right!</p>
                                    </tab-content>
                                    <tab-content title="" icon="far fa-user">
