            ...
            <div class="row layout-spacing layout-top-spacing" id="cancel-row">
                <div class="col-lg-12">
                    <div class="panel-body searchable-container" :class="[grid_type]">
                            ...
                            <div
                                ...
                                <form class="form-inline my-2 my-lg-0">
                                    <div class="">
                                        ...
                                        <input type="text" v-model.trim="search_user"
                                            class="product-search form-control" v-on:keyup="search_contacts()"
                        ...
                        <div id="addContactModal" class="modal fade" aria-labelledby="exampleModalLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-md modal-dialog-right">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">{{ 'Adicionar/Remover Permisões' }}</h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="panel-body justify-tab tabs">
                                            ...
                                            <div class="tab-content" id="justifyTabContent">
                                                ...
                                                <div class="tab-pane fade active show" id="user-permissao"
                                                    role="tabpanel" aria-labelledby="justify-profile-tab">
                                                                ...
                                                                <form>
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="form-check"
                                                                            v-for="mod in modulosSistema" :key="mod.id">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn" data-dismiss="modal"
                                            data-bs-dismiss="modal"><i class="flaticon-cancel-12"></i> Cancelar</button>
                                        <button type="button" class="btn btn-success" @click="save_user()">{{ params.id
                                            ?
