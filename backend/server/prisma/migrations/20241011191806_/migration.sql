...
-- AddForeignKey
ALTER TABLE "usuarios" ADD CONSTRAINT "usuarios_tipoUsuarioId_fkey" FOREIGN KEY ("tipoUsuarioId") REFERENCES "tipo_usuario_enum"("id") ON DELETE SET NULL ON UPDATE CASCADE;
