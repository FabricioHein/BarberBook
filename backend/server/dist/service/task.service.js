...
let TaskService = class TaskService {
    constructor(anotacaoRepository, taskRepositorio, arquivosRepository, motivosRepository, logTasksRepository) {
    ...
    async atualizarAnotacao(data) {
        try {
            ...
            return await this.anotacaoRepository.updateAnotacao(id, dataAnotacao);
        }
        catch (error) {
            return (0, msg_response_1.ErroBadRequest)(error);
        }
