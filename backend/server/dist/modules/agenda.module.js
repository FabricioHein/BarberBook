...
AgendaModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [task_repository_1.TaskRepository, clientes_repository_1.ClientesRepository, usuario_repository_1.UsuarioRepository, agenda_repository_1.AgendaRepository, agenda_service_1.AgendaService, PrismaService_1.PrismaService, configCliente_repository_1.ConfigClienteRepository],
    })
], AgendaModule);
