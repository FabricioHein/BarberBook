...
let AgendaController = class AgendaController {
    ...
    async getHorariosDisponiveisApp(req) {
        try {
    ...
    async getHorariosDisponiveis(req) {
        try {
            return await this.agendaService.getHorariosDisponiveis(req.body);
        }
        catch (error) {
...
__decorate([
    (0, common_1.Get)('agendamento/:uuid'),
    __param(0, (0, common_1.Param)('uuid')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], AgendaController.prototype, "getDataAgendamento", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Post)('horarios-disponiveis-app'),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], AgendaController.prototype, "getHorariosDisponiveisApp", null);
__decorate([
    (0, common_1.Post)('horarios-disponiveis'),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], AgendaController.prototype, "getHorariosDisponiveis", null);
__decorate([
